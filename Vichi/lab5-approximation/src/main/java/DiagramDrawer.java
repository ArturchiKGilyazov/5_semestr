...
public class DiagramDrawer extends Application {
    ...
    public void start(Stage s) throws Exception {
        Counter counter = new SinCounter();
        Pane p = new Pane();
        ObservableList sl = FXCollections.observableArrayList();
//        ObservableList l1 = counter.getFirstCoords();
//        ObservableList l1 = counter.getSecondCoords();
        ...
        Axis x = new NumberAxis("x", 0, 5, 1);
        Axis y = new NumberAxis("y", -2, 2, 2);
